...
const styles = StyleSheet.create({
  ...
  greetingLabel: { fontSize: 11, fontWeight: "600", textTransform: "uppercase", letterSpacing: 1 },
  ...
  badge: { position: "absolute", top: 8, right: 8, width: 7, height: 7, borderRadius: 4, backgroundColor: "#B91C1C", borderWidth: 1.5, borderColor: "#FFFFFF" },
  dateChip: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999 },
